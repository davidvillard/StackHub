const resources = {
  icons: [
    ...
    },
    {
      id: 2,
      title: "Svgl",
      description: "SVGL es una plataforma que ofrece una colección gratuita de gráficos SVG personalizables, como iconos e ilustraciones, listos para usar en proyectos web. Optimizado para facilidad de uso y rápida integración.",
      url: "https://svgl.app/",
  ...
  illustrations: [
    ...
    },
    {
      id: 2,
      title: "DrawKit",
      description: "DrawKit es una biblioteca de ilustraciones vectoriales gratuitas y premium diseñadas para proyectos web y móviles. Con una amplia variedad de estilos y temas, DrawKit es ideal para diseñadores que buscan ilustraciones de alta calidad para mejorar la apariencia de sus proyectos. La plataforma ofrece ilustraciones en formatos SVG y PNG, lo que permite una fácil integración en cualquier diseño. DrawKit también incluye opciones de personalización, como la capacidad de cambiar colores y ajustar elementos para adaptarse a las necesidades del proyecto. Además, DrawKit es de código abierto y ofrece una selección gratuita de ilustraciones, lo que lo convierte en una opción accesible para proyectos de cualquier escala.",
    ...
    },
    {
      ...
      description: "Flowbite Illustrations es una colección de ilustraciones vectoriales diseñadas para complementar interfaces de usuario modernas. Estas ilustraciones están disponibles en una variedad de estilos y temas, lo que las hace ideales para proyectos web y móviles. Una de las características destacadas de Flowbite Illustrations es su enfoque en la coherencia visual. Todas las ilustraciones siguen un estilo uniforme, lo que garantiza que se vean bien juntas en cualquier proyecto. Además, las ilustraciones son altamente personalizables, lo que permite a los diseñadores ajustar colores y estilos según sus necesidades. Flowbite Illustrations es de código abierto y completamente gratuito, lo que lo convierte en una excelente opción para equipos que buscan agregar ilustraciones atractivas y profesionales a sus proyectos sin incurrir en costos adicionales.",
  ...
  colors: [
    {
      id: 1,
      title: "Coolors",
      description: "Coolors es una herramienta en línea que permite a los usuarios generar y explorar paletas de colores de manera rápida y sencilla. Con una interfaz intuitiva y opciones de personalización, Coolors es ideal para diseñadores que buscan crear combinaciones de colores atractivas y coherentes. La plataforma permite a los usuarios ajustar colores, generar paletas aleatorias y explorar tendencias de color. Coolors también ofrece opciones para guardar y exportar paletas en diferentes formatos, lo que facilita su uso en proyectos de diseño. Además, Coolors es completamente gratuito y ofrece una aplicación móvil para generar paletas sobre la marcha.",
    ...
    },
    {
      id: 4,
      title: "Tints Dev",
      description: "Tints Dev es una plataforma ideal para quienes buscan generar variaciones de un color base, creando diferentes tonos y matices de forma automática. Es especialmente útil para diseñadores y desarrolladores que necesitan una escala de colores para aplicar en interfaces, branding y diseño gráfico.\n\nAdemás de la generación de tonos, Tints Dev ofrece herramientas para exportar paletas en distintos formatos y asegurar una coherencia cromática en los proyectos. Su interfaz minimalista y rápida permite experimentar con combinaciones sin distracciones.",
    ...
    },
    {
      ...
      description: "RealTime Colors es una herramienta innovadora que permite visualizar combinaciones de colores en tiempo real. Los diseñadores pueden ajustar tonos y contrastes instantáneamente y ver cómo afectan la legibilidad y la estética de una interfaz sin necesidad de recargar la página o hacer pruebas manuales.\n\nLa plataforma también ofrece compatibilidad con fuentes personalizadas y permite generar enlaces compartibles con combinaciones de colores guardadas. Esto facilita la colaboración entre diseñadores y equipos de desarrollo, asegurando que las paletas sean efectivas y atractivas.",
  ...
  components: [
    ...
    },
    {
      id: 4,
      title: "Mamba UI",
      description: "Mamba UI es una colección de componentes de interfaz de usuario de código abierto diseñados con Tailwind CSS. Su objetivo es proporcionar elementos listos para usar que ayuden a los desarrolladores a construir interfaces web atractivas y funcionales sin necesidad de diseñar desde cero.\n\nLa biblioteca incluye una variedad de componentes como botones, formularios, tablas y tarjetas, todos optimizados para la accesibilidad y la usabilidad. Mamba UI es ideal para quienes buscan rapidez y flexibilidad en el desarrollo de sus proyectos web.",
    ...
    },
    {
      id: 5,
      title: "Floating UI",
      description: "Floating UI es una biblioteca especializada en la creación de elementos flotantes como tooltips, popovers, dropdowns y menús contextuales. Su enfoque principal es mejorar la colocación y el posicionamiento de estos elementos para garantizar una experiencia de usuario óptima.\n\nOfrece una API flexible y ligera que se puede integrar con diversas bibliotecas y frameworks. Gracias a su enfoque modular, los desarrolladores pueden personalizar su comportamiento y apariencia sin afectar el rendimiento de la aplicación.",
  ...
  inspirations: [
    {
      id: 1,
      title: "Patterns",
      description: "Colección de patrones y buenas prácticas para el desarrollo frontend.",
  ...
  librerias: [
    {
      id: 1,
      title: "React Icons",
      description: "Librería de iconos basada en React con soporte para múltiples packs populares.",
    ...
    },
    {
      id: 2,
      title: "Atropos JS",
      description: "Efecto de paralaje interactivo fluido y altamente personalizable.",
    ...
    },
    {
      id: 3,
      title: "Swiper",
      description: "Uno de los mejores sliders y carruseles para la web moderna.",
    ...
    },
    {
      id: 4,
      title: "Toastify JS",
      description: "Librería ligera para mostrar notificaciones flotantes elegantes.",
    ...
    },
    {
      ...
      description: "Otro conjunto de animaciones listas para usar con Tailwind CSS.",
    ...
    },
    {
      id: 7,
      title: "Astro UI",
      description: "Colección de componentes accesibles y reutilizables para UI.",
  ...
  ia: [
    ...
    },
    {
      id: 3,
      title: "ChatGPT",
      description: "Modelo de IA para generación de texto y asistencia conversacional.",
