...
const ButtonGitHubStar = () => {
  return (
    <button
      className={clsx(
        "flex overflow-hidden items-center text-md font-medium focus-visible:outline-none",
        "focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
        "bg-black text-white shadow hover:bg-black/90 h-9 px-6 py-3 max-w-52 whitespace-pre",
        "md:flex group relative w-full justify-center gap-2 rounded-md transition-all duration-300 ease-out",
        "hover:ring-2 hover:ring-black hover:ring-offset-2 mt-12 hover:shadow-gray-600 cursor-pointer"
      )}
    >
      ...
      <div className="ml-2 flex items-center gap-1 text-sm md:flex">
        ...
        <span className="inline-block tabular-nums tracking-wider font-display font-medium text-white">0</span>
      </div>
    </button>
  );
};

export default ButtonGitHubStar;